    ...
    <div style={{ minHeight: "100vh", background: pageBg, padding: 20 }}>
      <div style={{ maxWidth: 1280, margin: "0 auto", display: "flex", flexDirection: "column", gap: 14 }}>
        <div style={card}>
          ...
          >
            <div>
              <div style={{ fontSize: headerFont, fontWeight: 900, color: textMain }}>{statusLine}</div>
            ...
            <div style={{ display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap" }}>
              <button onClick={() => setBigMode((v) => !v)} style={btnDark} type="button">
        ...
        <div style={card}>
          ...
          >
            <div style={{ fontSize: 17, fontWeight: 900, color: textMain }}>Draft Board</div>
          ...
          >
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize }}>
              <thead>
                ...
                >
                  <th style={{ textAlign: "left", padding: cellPad, borderBottom: "1px solid #333333" }}>Overall</th>
                  <th style={{ textAlign: "left", padding: cellPad, borderBottom: "1px solid #333333" }}>Round</th>
                  <th style={{ textAlign: "left", padding: cellPad, borderBottom: "1px solid #333333" }}>Pick</th>
                  <th style={{ textAlign: "left", padding: cellPad, borderBottom: "1px solid #333333" }}>Coach</th>
                  <th style={{ textAlign: "left", padding: cellPad, borderBottom: "1px solid #333333" }}>Player #</th>
                  <th style={{ textAlign: "left", padding: cellPad, borderBottom: "1px solid #333333" }}>Player</th>
                  <th style={{ textAlign: "left", padding: cellPad, borderBottom: "1px solid #333333" }}>Pos</th>
                  <th style={{ textAlign: "left", padding: cellPad, borderBottom: "1px solid #333333" }}>Club</th>
                  <th style={{ textAlign: "left", padding: cellPad, borderBottom: "1px solid #333333" }}>Avg</th>
                </tr>
              </thead>
              ...
              <tbody>
                {rows.map((r, idx) => {
                  ...
                  const bg = isCurrent ? "#ffe08a" : idx % 2 === 0 ? "#ffffff" : "#f8fafc";
                  ...
                  return (
                    ...
                    >
                      <td style={{ padding: cellPad, borderBottom: "1px solid #eaecf0", width: 140, color: textMain }}>
                      ...
                      <td style={{ padding: cellPad, borderBottom: "1px solid #eaecf0", width: 80, color: textMain }}>
                        {r.round}
                      </td>
                      ...
                      <td style={{ padding: cellPad, borderBottom: "1px solid #eaecf0", minWidth: 220, color: textMain }}>
                        <strong style={{ fontSize: bigMode ? 16 : 13 }}>
                          {r.coach_name || (r.coach_id ? `Coach ${r.coach_id}` : "")}
                        </strong>
                      </td>

                      <td style={{ padding: cellPad, borderBottom: "1px solid #eaecf0", width: 110, color: textMain }}>
                        {picked ? r.player!.player_no : ""}
                      </td>

                      <td style={{ padding: cellPad, borderBottom: "1px solid #eaecf0", minWidth: 240, color: textMain }}>
                        {picked ? (
                      ...
                      <td style={{ padding: cellPad, borderBottom: "1px solid #eaecf0", width: 90, color: textMain }}>
                        {picked ? r.player!.pos : ""}
                      </td>

                      <td style={{ padding: cellPad, borderBottom: "1px solid #eaecf0", width: 130, color: textMain }}>
          ...
          <div style={{ marginTop: 10, fontSize: 12, color: textSoft }}>
            Tip: the highlighted row shows the live pick currently on the clock.
          </div>
        </div>
      </div>
    </div>
